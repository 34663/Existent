...
public class CFontRenderer extends CFont {
    ...
    public float drawString(String text, double x, double y, int color, final boolean shadow) {
        if (Existent.getModuleManager().isEnabled(StreamerMode.class) && (Boolean) Existent.getModuleManager().getClazz(StreamerMode.class).getSetting(StreamerMode.SCRAMBLE).getValue() && (Minecraft.getMinecraft().theWorld != null || Minecraft.getMinecraft().thePlayer != null)) {
