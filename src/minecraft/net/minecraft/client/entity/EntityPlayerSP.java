...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        final EventPushOutBlock pushOutBlockPre = new EventPushOutBlock(true);
        final EventPushOutBlock pushOutBlockPost = new EventPushOutBlock(false);
        pushOutBlockPre.call();

        if (this.noClip || pushOutBlockPre.isCancelled()) {
            return false;
        } else {
