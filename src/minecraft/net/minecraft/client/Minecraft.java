...
import zyx.existent.gui.screen.*;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    private void startGame() throws LWJGLException {
        ...
        final Existent client = Existent.instance;
        client.setup();

        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new GuiExLogin(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(new GuiExLogin());
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Existent.CLIENT_NAME);
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = new GuiExMainMenu();
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
            guiScreenIn = new GuiGameOver((ITextComponent) null);
        }

        if (guiScreenIn instanceof GuiExMainMenu || guiScreenIn instanceof GuiMultiplayer) {
    ...
    private void runGameLoop() throws IOException {
        ...
        AnimationUtil.delta2 = deltaTime;

        long thisFrame = System.currentTimeMillis();
        AnimationUtil.delta = (float)(thisFrame - this.lastFrame2) / 1000.0F;
        this.lastFrame2 = thisFrame;
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            if (objectMouseOver != null) {
                EventAttack eventAttack = new EventAttack(objectMouseOver.entityHit, true);
                eventAttack.call();
            }
            ...
            if (this.objectMouseOver == null) {
                ...
                EventAttack eventAttack1 = new EventAttack(objectMouseOver.entityHit, false);
        ...
        while (Keyboard.next()) {
            ...
            if (flag) {
                ...
                if (this.currentScreen == null) {
                    ...
                    eventKey.call();
                    for (Module m : Existent.getModuleManager().getModules()) {
                        if ((Keyboard.getEventKey() == m.getKeybind()) && !(Keyboard.getEventKey() == 0)) {
                            m.toggle();
                        }
                    }
                ...
                if (k != 0) {
                    if (this.thePlayer.isSpectator()) {
                        ...
                        if (this.ingameGUI.getSpectatorGui().isMenuActive()) {
                            ...
                            float f = MathHelper.clamp(this.thePlayer.capabilities.getFlySpeed() + (float) k * 0.005F, 0.0F, 0.2F);
    ...
    public MusicTicker.MusicType getAmbientMusicType() {
        if (this.currentScreen instanceof GuiWinGame) {
            ...
            if (this.thePlayer.world.provider instanceof WorldProviderHell) {
                return MusicTicker.MusicType.NETHER;
            } else if (this.thePlayer.world.provider instanceof WorldProviderEnd) {
